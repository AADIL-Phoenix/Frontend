          ...
          <div className="row g-5">
            ...
            <div className="col-md-4">
              <Card className="h-100 border-0 shadow-lg-hover overflow-hidden">
                ...
                <Card.Body className="p-4 pt-5 position-relative">
                  <Card.Title className="h4 fw-bold mb-3">Smart Notifications</Card.Title>
                  <Card.Text className="text-muted">
                    Stay informed with intelligent alerts for deadlines and updates.
                  </Card.Text>
                </Card.Body>
              </Card>
            </div>
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h2 className="fw-bold text-white mb-4">Ready to Transform Your Team's Productivity?</h2>
              <p className="lead text-white-75 mb-5">
                Experience the power of professional task management with a personalized demo
              </p>
              <div className="d-flex justify-content-center gap-3">
                <Button variant="light" size="lg" className="px-4 py-2 fw-medium">
                  Request Demo
                </Button>
                <Button variant="outline-light" size="lg" className="px-4 py-2 fw-medium">
                  Contact Sales
                </Button>
              </div>
            </div>
